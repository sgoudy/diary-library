...
// Create a test user.
let userid = '';
const email = 'unit@collection-update-test.com';
...
describe("When updating a Collection:", () => {
  ...
  it("it should return 400 if the user id is missing.", (done)=>{
...
it("it should return 400 if the collection title is missing.", (done)=>{
    agent.put('/api/collections/title')
    .set('content-type', 'multipart/form-data')
    //.field('title', 'Science Fiction')
    .field('userid', userid)
  ...
  it("it should return 400 if the collection id is missing.", (done)=>{
    agent.put('/api/collections/title')
    .set('content-type', 'multipart/form-data')
    .field('title', 'Science Fiction')
    .field('userid', userid)
  ...
  it("it should return 200 if a collection was successfully updated.", (done)=>{
    agent.put('/api/collections/title')
    .set('content-type', 'multipart/form-data')
    .field('title', 'Science Fiction')
    .field('userid', userid)
