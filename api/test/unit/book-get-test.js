...
// Create a test user.
let userid = '';
const email = 'unit@book-get-test.com';
...
describe("Retrieving a Book:", () => {

  it("should return 404 if the user id is missing.", (done)=>{
  ...
  it('should return 404 if the book id is missing.', (done) => {
    const url = `/api/book/${userid}`;
    agent.get(url)
        .end((err,res) => {
          assert(!err);
          res.should.have.status(404);
  ...
  it("should return 200 and tHe Book object when requested and existing book.", (done)=>{
