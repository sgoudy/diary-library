...
// Create a test user.
let userid = '';
const email = 'unit@collection-post-test.com';
...
describe("When creating a new collection:", () => {
    ...
    it("it should return 400 if the title is missing.", (done) => {
        agent.post('/api/collections/new')
        .set('content-type', 'multipart/form-data')
        .field('userid', userid)
        .end((err, res) => {
    ...
    it("it should return 201 if the collection was successfully created.", (done) => {
      agent.post('/api/collections/new')
        .set('content-type', 'multipart/form-data')
        .field('title', 'Short Fiction')
        .field('userid', userid)
